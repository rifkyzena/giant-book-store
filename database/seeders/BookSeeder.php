    ...
    public function run()
    {
        $books = [
            ...
            [
                ...
                'image' => 'books/the-secret-of-red-sky.png'
            ],
            [
                'publisher_id' => '1',
                ...
                'image' => 'books/credit-roll-of-the-fool.png'
            ],
            [
                'publisher_id' => '1',
                ...
                'image' => 'books/blue-painful-and-brittle.png'
            ],
            [
                'publisher_id' => '1',
                'name' => 'Real Face',
            ...
            [
                ...
                'image' => 'books/one-small-step-can-change-your-life.png'
            ],
            [
                'publisher_id' => '2',
                ...
                'image' => 'books/unlimited-memory.png'
            ],
            [
                'publisher_id' => '2',
                ...
                'image' => 'books/aku-mendengarmu.png'
            ],
            [
                'publisher_id' => '2',
                ...
                'image' => 'books/ego-is-the-enemy.png'
            ],
            [
                'publisher_id' => '3',
                ...
                'image' => 'books/solusi-praktis-dan-mudah-menguasai-spss-20-untuk-pengolahan-data.png'
            ],
            [
                'publisher_id' => '3',
                ...
                'image' => 'books/seri-belajar-sekejap-microsioft-office-365.png'
            ],
            [
                'publisher_id' => '3',
                ...
                'image' => 'books/membangun-web-interaktif-dengan-adobe-dreamweaver-css-5-php-dan-mysql.png'
            ],
            [
                'publisher_id' => '3',
                ...
                'image' => 'books/menjadi-pelukis-digital-dengan-coreldraw-x6-dan-photoshop-cs6.png'
            ],
            [
                'publisher_id' => '3',
                ...
                'image' => 'books/membangun-warnet-sendiri-berbasis-wifi.png'
            ],
        ];
